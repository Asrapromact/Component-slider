	...
	$.Gallery.prototype 	= {
		...
		_loadEvents			: function() {
			...
			this.$navPrev.on( 'click.gallery', function( event ) {
				 if($('.dg-center')){
                    setTimeout(function(){ 
                       $('.dg-center').children().find('span.counter').counterUp({
                        delay: 10,
                        time:2000
                        });  
                    }, 1000);
		...
		_getCoordinates		: function( position ) {
			...
			if( windowWidth >= 481 && this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					...
					case 'center':
						return {
							'-webkit-transform'	: 'translateX(0px) translateZ(20px) rotateY(0deg)',
							'-moz-transform'	: 'translateX(0px) translateZ(20px) rotateY(0deg)',
							'-o-transform'		: 'translateX(0px) translateZ(20px) rotateY(0deg)',
							'-ms-transform'		: 'translateX(0px) translateZ(20px) rotateY(0deg)',
